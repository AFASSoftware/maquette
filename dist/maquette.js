(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.maquette = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
// Utilities
var emptyArray = [];
 ...
 */
exports.h = function (selector /*, ...propertiesAndChildren */) {
 ...
 * @returns {Mapping}
 */
exports.createMapping = function (getSourceKey, createResult, updateResult /*, deleteTarget*/) {
    var keys = [];
    var results = [];
    return {
        /**
...
exports.createProjector = function (projectionOptions) {
    ...
    var projector = {
        ...
        evaluateHyperscript: function (rootNode, parameters) {
            ...
            var parameterValues = [{ h: exports.h, dom: exports.dom, createCache: exports.createCache, createMapping: exports.createMapping, createProjector: exports.createProjector }, exports.h, projector];
            Object.keys(parameters).forEach(function (parameterName) {
                functionParameters.push(parameterName);
                parameterValues.push(parameters[parameterName]);
            });
            Array.prototype.forEach.call(nodes, function (node) {
                var func = new (Function.bind.apply(Function, [void 0].concat(functionParameters, ["return " + node.textContent.trim()])))();
